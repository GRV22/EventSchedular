...
<body>
<%
String eventName = "TestEvent";//request.getParameter("eventName");
String summary = "Summary";//request.getParameter("summary");
String startTime = "2017-06-22T01:00:00+05:30";//request.getParameter("startTime");
